...
module.exports = {
  ...
  actionSignIn: async (req, res) => {
    try {
      ...
      if (!user) {
        req.flash("alertMessage", "Invalid Username !!!");
        req.flash("alertStatus", "danger");
        res.redirect("/admin/signin");
      }
  ...
  //* End Feature CRUD Function *//

  //* Feature CRUD Function *//
  addFeature: async (req, res) => {
    const { name, qty, itemId } = req.body;
    try {
      if (!req.file) {
        req.flash("alertMessage", "Please insert a image");
        req.flash("alertStatus", "danger");
        res.redirect(`/admin/item/show-detail-item/${itemId}`);
      }
      ...
      item.save();
      req.flash("alertMessage", "Feature has been Added");
      req.flash("alertStatus", "success");
      res.redirect(`/admin/item/show-detail-item/${itemId}`);
    } catch (error) {
      req.flash("alertMessage", `${error.message}`);
  ...
  editFeature: async (req, res) => {
    ...
    try {
      ...
      if (req.file == undefined) {
        ...
        feature.qty = qty;
        await feature.save();
        req.flash("alertMessage", "Feature has been Updated");
        req.flash("alertStatus", "success");
        res.redirect(`/admin/item/show-detail-item/${itemId}`);
      } else {
  ...
  deleteFeature: async (req, res) => {
    ...
    try {
      ...
      req.flash("alertMessage", "Feature has been Deleted");
      req.flash("alertStatus", "success");
      res.redirect(`/admin/item/show-detail-item/${itemId}`);
    } catch (error) {
      req.flash("alertMessage", `${error.message}`);
  ...
  addActivity: async (req, res) => {
    ...
    try {
      ...
      item.save();
      req.flash("alertMessage", "Activity has been Added");
      req.flash("alertStatus", "success");
      res.redirect(`/admin/item/show-detail-item/${itemId}`);
    } catch (error) {
      req.flash("alertMessage", `${error.message}`);
  ...
  editActivity: async (req, res) => {
    ...
    try {
      ...
      if (req.file == undefined) {
        ...
        activity.type = type;
        await activity.save();
        req.flash("alertMessage", "Activity has been Updated");
        req.flash("alertStatus", "success");
        res.redirect(`/admin/item/show-detail-item/${itemId}`);
      } else {
  ...
  deleteActivity: async (req, res) => {
    ...
    try {
      ...
      req.flash("alertMessage", "Activity has been Deleted");
      req.flash("alertStatus", "success");
      res.redirect(`/admin/item/show-detail-item/${itemId}`);
    } catch (error) {
      req.flash("alertMessage", `${error.message}`);
